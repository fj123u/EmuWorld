...
pub fn get_catalog() -> Vec<EmulatorInfo> {
    vec![
        ...
        EmulatorInfo {
            id: "lime3ds".to_string(),
            name: "Lime3DS".to_string(),
            ...
            download_url: "https://github.com/Lime3DS/Lime3DS/releases/download/2119.2/lime3ds-2119.2-windows-msvc.zip".to_string(),
            executable_name: "lime3ds-gui.exe".to_string(),
            supported_extensions: vec!["3ds".to_string(), "cci".to_string(), "cxi".to_string(), "app".to_string(), "3dsx".to_string(), "cia".to_string()],
            icon: "🎲".to_string(),
            website: "https://lime3ds.github.io/".to_string(),
            archive_type: "zip".to_string(),
            category: "Nintendo".to_string(),
            core_name: None,
            setup_files: vec![],
