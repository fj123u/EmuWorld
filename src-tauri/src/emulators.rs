...
/// All download URLs point to direct ZIP downloads from GitHub releases.
pub fn get_catalog() -> Vec<EmulatorInfo> {
    vec![
        EmulatorInfo {
            ...
            download_url: "https://github.com/mgba-emu/mgba/releases/download/0.10.4/mGBA-0.10.4-win64.zip".to_string(),
        ...
        EmulatorInfo {
            ...
            download_url: "https://github.com/melonDS-emu/melonDS/releases/download/0.9.5/melonDS_win_x64.zip".to_string(),
        ...
        EmulatorInfo {
            ...
            download_url: "https://www.pj64-emu.com/file/project64-3-0-1-5664-2df3434".to_string(),
        ...
        EmulatorInfo {
            ...
            description: "The most trusted PlayStation 2 emulator with a Qt interface and Vulkan support.".to_string(),
            download_url: "https://github.com/PCSX2/pcsx2/releases/download/v2.1.230/pcsx2-v2.1.230-windows-x64-Qt.zip".to_string(),
        ...
        EmulatorInfo {
            ...
            download_url: "https://buildbot.libretro.com/stable/1.19.1/windows/x86_64/RetroArch.zip".to_string(),
