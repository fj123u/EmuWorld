...
pub fn get_catalog() -> Vec<EmulatorInfo> {
    vec![
        ...
        EmulatorInfo {
            ...
            download_url: "http://0ldsk00l.ca/nestopia/1.53.2_win32.zip".to_string(),
        ...
        EmulatorInfo {
            ...
            download_url: "https://github.com/ryujinx-mirror/ryujinx/releases/download/1.1.1403/ryujinx-1.1.1403-win_x64.zip".to_string(),
            ...
            icon: "🎌".to_string(),
            website: "https://ryujinx.org".to_string(),
            archive_type: "zip".to_string(),
            category: "Nintendo".to_string(),
        },
        EmulatorInfo {
        ...
        EmulatorInfo {
            ...
            download_url: "https://github.com/RPCS3/rpcs3-binaries-win/releases/latest/download/rpcs3-win64.7z".to_string(),
        ...
        EmulatorInfo {
            ...
            download_url: "https://github.com/xemu-project/xemu/releases/latest/download/xemu-win-x86_64.zip".to_string(),
