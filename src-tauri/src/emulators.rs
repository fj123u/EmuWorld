...
pub fn get_catalog() -> Vec<EmulatorInfo> {
    vec![
        ...
        EmulatorInfo {
            ...
            download_url: "https://git.ryujinx.app/projects/Ryubing/releases/download/1.3.3/ryujinx-1.3.3-win_x64.zip".to_string(),
        ...
        EmulatorInfo {
            id: "retroarch-nes".to_string(),
            name: "RetroArch (NES)".to_string(),
            console: "NES".to_string(),
            description: "NES via RetroArch's Mesen core. Supports netplay.".to_string(),
            ...
            archive_type: "7z".to_string(),
            category: "Nintendo".to_string(),
            core_name: Some("mesen_libretro.dll".to_string()),
            setup_files: vec![
                SetupFile {
        ...
        EmulatorInfo {
            ...
            name: "RetroArch (SNES)".to_string(),
            console: "Super Nintendo".to_string(),
            description: "Super Nintendo via RetroArch's Snes9x core. Supports netplay.".to_string(),
            download_url: "https://buildbot.libretro.com/stable/1.20.0/windows/x86_64/RetroArch.7z".to_string(),
            executable_name: "retroarch.exe".to_string(),
            supported_extensions: vec!["sfc".to_string(), "smc".to_string()],
            icon: "🟣".to_string(),
            ...
            archive_type: "7z".to_string(),
            category: "Nintendo".to_string(),
            core_name: Some("snes9x_libretro.dll".to_string()),
            setup_files: vec![
                SetupFile {
        ...
        EmulatorInfo {
            id: "retroarch-gba".to_string(),
            name: "RetroArch (GBA)".to_string(),
            console: "Game Boy Advance".to_string(),
            description: "Game Boy Advance via RetroArch's mGBA core. Supports netplay.".to_string(),
            download_url: "https://buildbot.libretro.com/stable/1.20.0/windows/x86_64/RetroArch.7z".to_string(),
            executable_name: "retroarch.exe".to_string(),
            supported_extensions: vec!["gba".to_string(), "gb".to_string(), "gbc".to_string()],
            icon: "🟢".to_string(),
        ...
        EmulatorInfo {
            id: "retroarch-n64".to_string(),
            name: "RetroArch (N64)".to_string(),
            console: "Nintendo 64".to_string(),
            description: "Nintendo 64 via RetroArch's Mupen64Plus-Next core. Supports netplay.".to_string(),
            download_url: "https://buildbot.libretro.com/stable/1.20.0/windows/x86_64/RetroArch.7z".to_string(),
            executable_name: "retroarch.exe".to_string(),
            supported_extensions: vec!["n64".to_string(), "z64".to_string(), "v64".to_string()],
            icon: "🟡".to_string(),
            website: "https://www.retroarch.com".to_string(),
            archive_type: "7z".to_string(),
            category: "Nintendo".to_string(),
            core_name: Some("mupen64plus_next_libretro.dll".to_string()),
            setup_files: vec![
                SetupFile {
        ...
        EmulatorInfo {
            id: "retroarch-nds".to_string(),
            name: "RetroArch (DS)".to_string(),
            console: "Nintendo DS".to_string(),
            description: "Nintendo DS via RetroArch's melonDS core. Supports netplay.".to_string(),
            download_url: "https://buildbot.libretro.com/stable/1.20.0/windows/x86_64/RetroArch.7z".to_string(),
            executable_name: "retroarch.exe".to_string(),
            supported_extensions: vec!["nds".to_string()],
            icon: "📱".to_string(),
            website: "https://www.retroarch.com".to_string(),
            archive_type: "7z".to_string(),
            category: "Nintendo".to_string(),
            core_name: Some("melonds_libretro.dll".to_string()),
            setup_files: vec![
                SetupFile {
        ...
        EmulatorInfo {
            id: "retroarch-dc".to_string(),
            name: "RetroArch (Dreamcast)".to_string(),
            console: "Dreamcast".to_string(),
            description: "Sega Dreamcast via RetroArch's Flycast core. Supports netplay.".to_string(),
            download_url: "https://buildbot.libretro.com/stable/1.20.0/windows/x86_64/RetroArch.7z".to_string(),
            executable_name: "retroarch.exe".to_string(),
            supported_extensions: vec!["cdi".to_string(), "gdi".to_string(), "chd".to_string(), "cue".to_string()],
            icon: "🌀".to_string(),
            website: "https://www.retroarch.com".to_string(),
            archive_type: "7z".to_string(),
            category: "Sega".to_string(),
            core_name: Some("flycast_libretro.dll".to_string()),
            setup_files: vec![
                SetupFile {
