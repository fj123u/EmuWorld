...
export default function App() {
  ...
  const [changelogs] = useState<ChangelogEntry[]>([
    { version: "0.2.7", date: "2026-03-19", changes: ["Nestopia replaced by Mesen 2 (64-bit) as default NES emulator", "Removed Nestopia-specific launch flags", "Mesen 2 now handles all NES/SNES/GB games at once"] },
    { version: "0.2.6", date: "2026-03-19", changes: ["Added Mesen 2 as a robust NES alternative", "Improved path handling for NES ROMs"] },
